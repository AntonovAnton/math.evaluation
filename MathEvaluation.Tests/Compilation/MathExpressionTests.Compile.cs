...
public partial class MathExpressionTests(ITestOutputHelper testOutputHelper)
{
        ...
        string errorMessage)
    {
        ...
        var ex = Record.Exception(() => new MathExpression(mathString, null, CultureInfo.InvariantCulture).Compile());
        ...
        double varValue, double expectedValue)
    {
        ...
        var fn = mathString.Compile(parameters, _scientificContext, CultureInfo.InvariantCulture);
    ...
    public void MathExpression_CompileThenInvoke_HasCustomMinFn_ExpectedValue(string mathString, double expectedValue)
    {
        ...
        var fn = mathString.Compile(new { min }, null, CultureInfo.InvariantCulture);
    ...
    [Fact]
    public void MathExpression_CompileThenInvoke_HasExpressionVariablesInContext_ExpectedValue()
    {
        var x = "x1 + x2";
        var y = "x1 * x1";
        var mathString = "x + sin(y) + x1";
    ...
    public void MathExpression_CompileThenInvoke_HasFactorialOfNotIntegerNumber_ThrowArgumentException()
    {
        ...
        var ex = Record.Exception(() => new MathExpression(mathString, _scientificContext, CultureInfo.InvariantCulture).Compile()());
