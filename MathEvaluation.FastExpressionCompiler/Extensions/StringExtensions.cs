...
public static class StringExtensions
{
    ...
    public static Func<T, double> CompileFast<T>(this string mathString, T parameters, IMathContext? context = null, IFormatProvider? provider = null)
        => new FastMathExpression(mathString, context, provider).Compile(parameters);

    /// <inheritdoc cref="MathExpression.CompileDecimal{T}(T)" />
    public static Func<T, decimal> CompileDecimalFast<T>(this string mathString, T parameters, IMathContext? context = null, IFormatProvider? provider = null)
    ...
    public static Func<T, bool> CompileBooleanFast<T>(this string mathString, T parameters, IMathContext? context = null, IFormatProvider? provider = null)
    ...
    public static Func<T, Complex> CompileComplexFast<T>(this string mathString, T parameters, IMathContext? context = null, IFormatProvider? provider = null)
