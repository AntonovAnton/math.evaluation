...
public partial class MathExpressionTests_Decimal
{
    ...
    public void FastMathExpression_CompileDecimalThenInvoke_HasPi_ExpectedValue(string mathString, double expectedValue)
    {
    ...
    public void FastMathExpression_CompileDecimalThenInvoke_HasTau_ExpectedValue(string mathString, double expectedValue)
    {
        using var expression = new FastMathExpression(mathString, _scientificContext, CultureInfo.InvariantCulture);
        expression.Evaluating += SubscribeToEvaluating;
    ...
    [InlineData("CSCH -1.4436354751788103", -0.5d)]
    [InlineData("Csch-0.88137358701954294", -1.0000000000000002d)]
    public void FastMathExpression_CompileDecimalThenInvoke_HasHyperbolicTrigonometricFn_ExpectedValue(string mathString,
