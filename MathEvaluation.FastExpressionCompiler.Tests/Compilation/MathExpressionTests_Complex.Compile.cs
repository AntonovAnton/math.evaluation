...
public partial class MathExpressionTests_Complex(ITestOutputHelper testOutputHelper)
{
    ...
    public void FastMathExpression_CompileComplexThenInvoke_HasNumbersInSpecificCulture_ExpectedValue(string mathString, string? cultureName)
    {
    ...
    public void FastMathExpression_CompileComplexThenInvoke_HasCommaAsDecimalSeparatorInNumbers_ExpectedValue(string mathString, double expectedValue,
        string cultureName)
    {
    ...
    public void FastMathExpression_CompileComplexThenInvoke_HasNumbersInSpecificCultureAsOperand_ExpectedValue(string mathString, string? cultureName,
    ...
    public void FastMathExpression_CompileComplexThenInvoke_HasVariable_ExpectedValue(string mathString,
    ...
    public void FastMathExpression_CompileComplexThenInvoke_HasGetValueFns_ExpectedValue(string mathString,
        double x1, double x2, double expectedValue)
    {
        ...
        var fn = mathString.CompileComplexFast(new { getX1, getX2 }, _scientificContext);
    ...
    public void FastMathExpression_CompileComplexThenInvoke_HasVariablesAndCustomFns_ExpectedValue(string mathString,
        double x1, double x2, double expectedValue)
    {
        testOutputHelper.WriteLine($"{mathString} = {expectedValue}");
        testOutputHelper.WriteLine($"x1 = {x1}, x2 = {x2}");
        ...
        var fn = mathString.CompileComplexFast(parameters, context);
        var value = fn(parameters);
    ...
    public void FastMathExpression_CompileComplexThenInvoke_HasCustomMinFn_ExpectedValue(string mathString, double expectedValue)
    {
        testOutputHelper.WriteLine($"{mathString} = {expectedValue}");
