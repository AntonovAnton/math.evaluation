...
{
    /// <summary>The exception of evaluating a math expression string.</summary>
    /// <seealso cref="System.ApplicationException" />
    [Serializable]
    public class MathEvaluationException : ApplicationException
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="MathEvaluationException" /> class.</summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="invalidTokenPosition">The invalid token position.</param>
        public MathEvaluationException(string message, int invalidTokenPosition = -1)
        ...
        /// </param>
        /// <param name="invalidTokenPosition">The invalid token position.</param>
        public MathEvaluationException(string message, Exception innerException, int invalidTokenPosition = -1)
        ...
        protected MathEvaluationException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
