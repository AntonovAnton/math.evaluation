...
{
    [TestFixture]
    public class ReflectionCalculatorTests
    {
        [OneTimeSetUp]
        public void Init()
        {
            ...
            TestContext.Progress.WriteLine($"{nameof(ReflectionCalculatorTests)}");
        }
        ...
        [TestCase("1 - -1", 2d)]
        public void ReflectionCalculator_Calculate_ExpectedValue(string expression, double expectedValue)
        {
